...
// 串口定义
#define LEFT_ENCODER_A_GPIO (7)
#define LEFT_ENCODER_A_GPIO_FUNC (IOT_GPIO_FUNC_GPIO_7_GPIO)
#define LEFT_ENCODER_B_GPIO (1)
#define LEFT_ENCODER_B_GPIO_FUNC (IOT_GPIO_FUNC_GPIO_1_GPIO)
#define RIGHT_ENCODER_A_GPIO (0)
#define RIGHT_ENCODER_A_GPIO_FUNC (IOT_GPIO_FUNC_GPIO_0_GPIO)
#define RIGHT_ENCODER_B_GPIO (12)
#define RIGHT_ENCODER_B_GPIO_FUNC (IOT_GPIO_FUNC_GPIO_12_GPIO)
...
void EncoderInit(void)
{
    ...
    RightWheel.Phase_B = RIGHT_ENCODER_B_GPIO;
    ...
    printf("Encoder init successfully!\n");
}
